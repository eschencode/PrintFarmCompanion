...
<div class="auth-wrap">
  ...
  >
    ...
    <p class="sub">Start managing your print farm.</p>
    ...
    <label>
      Your name
      <input name="name" type="text" autocomplete="name" value={form?.name ?? ""} placeholder="Linus" />
    </label>
    ...
    <label>
      Workspace name <span class="opt">(optional)</span>
      <input name="workspaceName" type="text" value={form?.workspaceName ?? ""} placeholder="Defaults to “Your name Printfarm”" />
    </label>
...
<style>
  ...
  .opt { color: #6b7890; font-weight: 400; }
  input {
    background: #0d131d;
